...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppForm.term_loan_d'
        db.add_column(u'iopapp_appform', 'term_loan_d',
                      self.gf('django.db.models.fields.CharField')(default='year', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppForm.term_loan_d'
        db.delete_column(u'iopapp_appform', 'term_loan_d')
    ...
    models = {
        u'iopapp.appform': {
            ...
            'term_loan_d': ('django.db.models.fields.CharField', [], {'default': "'year'", 'max_length': '10'}),
